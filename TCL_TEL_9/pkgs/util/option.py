...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        # basic opts
        self.parser.add_argument('--exp_name', default='test_1',type=str, help='Experiment name')
        ...
        self.parser.add_argument('--save_dir', default='/home/weijia.wu/workspace/Sence_Text_detection/Paper-ICDAR/TCL_TEL_9/pkgs/model_save/', help='Path to save checkpoint models')
        self.parser.add_argument('--vis_dir', default='/home/weijia.wu/workspace/Sence_Text_detection/Paper-ICDAR/TCL_TEL_9/pkgs/Test_result/train_show/', help='Path to save visualization images')
        self.parser.add_argument('--txt_dir',
                                 default='/home/weijia.wu/workspace/Sence_Text_detection/Paper-ICDAR/TCL_TEL_7/pkgs/Test_result/result_txt/',
                                 help='Path to save txt result')
        self.parser.add_argument('--gt_dir',
                                 default='/data/data_weijia/CTW1500_Total_ICDAR2019/gt/test_icdar2019',
                                 help='Path to input gt txt')
        ...
        self.parser.add_argument('--display_freq', default=800, type=int, help='display training metrics every # iterations')
        ...
        self.parser.add_argument('--tr_confi_thresh', default=0.2, type=float, help='tr_confi_thresh')
        self.parser.add_argument('--tcl_confi_thresh', default=0.54, type=float, help='tcl_confi_thresh')
        self.parser.add_argument('--up_confi_thresh', default=0.1, type=float, help='up_confi_thresh')
        self.parser.add_argument('--down_confi_thresh', default=0.1, type=float, help='down_confi_thresh')
        self.parser.add_argument('--left_confi_thresh', default=0.1, type=float, help='left_confi_thresh')
        self.parser.add_argument('--right_confi_thresh', default=0.1, type=float, help='right_confi_thresh')



        #evaluation
        self.parser.add_argument('--tp', default=0.6, type=float, help='tp_thresh')
        self.parser.add_argument('--tr', default=0.7, type=float, help='tr_thresh')
        self.parser.add_argument('--fsc_k', default=0.8, type=float, help='fsc_k_thresh')
        self.parser.add_argument('--k', default=2, type=float, help='k_thresh')
